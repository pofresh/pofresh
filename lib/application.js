...
Application.init = function (opts) {
    opts = opts || {};
    global.Promise = typeof global.Promise === 'function' ? global.Promise : require('es6-promise').Promise;
...
Application.beforeStopHook = function (fun) {
    logger.warn('this method was deprecated in pofresh 0.8');
...
Application.start = function (cb) {
    ...
    appUtil.startByType(this,  () => {
        ...
        let beforeFun = this.lifecycleCbs[Constants.LIFECYCLE.BEFORE_STARTUP];
        if (!!beforeFun) {
...
Application.stop = function (force) {
    ...
    if (!!stopFun) {
        ...
        utils.invokeCallback(fun, this, shutDown, cancelShutDownTimer);
    } else {
        shutDown();
    }
};
