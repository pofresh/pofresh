...
var transactionLogger = require('pofresh-logger').getLogger('transaction-log', __filename);
var transactionErrorLogger = require('pofresh-logger').getLogger('transaction-error-log', __filename);
