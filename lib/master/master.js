...
var logger = require('pofresh-logger').getLogger('pofresh', __filename);
var crashLogger = require('pofresh-logger').getLogger('crash-log', __filename);
var adminLogger = require('pofresh-logger').getLogger('admin-log', __filename);
var admin = require('pofresh-admin-fresh');
