...
var Package = require('pofresh-protocol').Package;
...
Command.prototype.handle = function(socket, msg) {
  ...
  if(this.useDict) {
    var dictVersion = pofresh.app.components.__dictionary__.getVersion();
  ...
  if(this.useProtobuf) {
    var protoVersion = pofresh.app.components.__protobuf__.getVersion();
  ...
  if(!!pofresh.app.components.__decodeIO__protobuf__) {
    ...
    var version = pofresh.app.components.__decodeIO__protobuf__.getVersion();
