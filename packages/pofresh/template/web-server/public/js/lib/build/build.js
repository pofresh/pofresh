...
require.register('pofreshnode-pofresh-jsclient-websocket/lib/pofresh-client.js', (exports, require, module) => {
    (() => {
        ...
        const sendMessage = (reqId, route, msg) => {
            ...
            const protos = pofresh.data.protos ? pofresh.data.protos.client : {};
            if (protos[route]) {
...
require.alias('pofresh-protocol/lib/protocol.test.js', 'boot/deps/pofresh-protocol/lib/protocol.js');
require.alias('pofresh-protocol/lib/protocol.test.js', 'boot/deps/pofresh-protocol/index.js');
require.alias('pofresh-protocol/lib/protocol.test.js', 'pofresh-protocol/index.js');

require.alias(
    'pofreshnode-pofresh-protobuf/lib/client/protobuf.js',
    'boot/deps/pofresh-protobuf/lib/client/protobuf.js'
);
...
require.alias(
    'pofreshnode-pofresh-jsclient-websocket/lib/pofresh-client.js',
    'boot/deps/pofresh-jsclient-websocket/lib/pofresh-client.js'
);
require.alias(
    'pofreshnode-pofresh-jsclient-websocket/lib/pofresh-client.js',
    'boot/deps/pofresh-jsclient-websocket/index.js'
);
require.alias(
    'pofreshnode-pofresh-jsclient-websocket/lib/pofresh-client.js',
    'pofreshnode-pofresh-jsclient-websocket/index.js'
);
