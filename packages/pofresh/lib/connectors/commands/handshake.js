...
class Command {
  ...
  handle(socket, msg) {
    ...
    if (this.useDict) {
      const dictVersion = pofresh.app.components.__dictionary__.getVersion();
    ...
    if (this.useProtobuf) {
      const protoVersion = pofresh.app.components.__protobuf__.getVersion();
    ...
    if (pofresh.app.components.__decodeIO__protobuf__) {
      ...
      const version = pofresh.app.components.__decodeIO__protobuf__.getVersion();
