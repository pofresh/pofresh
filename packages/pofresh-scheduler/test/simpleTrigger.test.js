const SimpleTrigger = require('../lib/simpleTrigger');
...
describe('SimpleTrigger', () => {
  describe('constructor', () => {
    ...
    test('should create trigger with infinite count when count is 0', () => {
      ...
      expect(trigger.count).toBe(0); // The actual implementation uses 0, not Infinity
    });
  });
  ...
  describe('nextExecuteTime', () => {
    test('should return start time for first execution', () => {
      ...
      expect(trigger.nextExecuteTime()).toBe(startTime);
    });
    ...
    test('should handle zero count as infinite', () => {
      ...
      expect(trigger.nextExecuteTime()).toBe(startTime + 100 * period);
    });
  });
